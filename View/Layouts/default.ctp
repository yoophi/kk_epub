...
<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">전자책 빌더 프로토타입</a>
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="<?= $this->Html->url('/') ?>">Home</a></li>
              <li><a href="<?= $this->Html->url('/my/books') ?>">E-Book</a></li>
              <li><a href="<?= $this->Html->url('/my/cardbooks') ?>">Cardbook</a></li>
              <li class="dropdown">
...
<!--
            <p class="navbar-text pull-right">
              Logged in as <a href="#" class="navbar-link"><?= $this->Session->read('Auth.User.username') ?></a>
<a href="<?= Router::url('/users/logout') ?>" class="btn btn-mini">로그아웃</a>
