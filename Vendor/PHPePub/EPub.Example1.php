...
logLine("getCurrentServerURL: " . $cardbook->getCurrentServerURL());
logLine("getCurrentPageURL..: " . $cardbook->getCurrentPageURL());

// Title and Identifier are mandatory!
$cardbook->setTitle("Test book");
$cardbook->setIdentifier("http://JohnJaneDoePublications.com/books/TestBook.html", EPub::IDENTIFIER_URI); // Could also be the ISBN number, prefered for published books, or a UUID.
$cardbook->setLanguage("en"); // Not needed, but included for the example, Language is mandatory, but EPub defaults to "en". Use RFC3066 Language codes, such as "en", "da", "fr" etc.
$cardbook->setDescription("This is a brief description\nA test ePub book as an example of building a book in PHP");
$cardbook->setAuthor("John Doe Johnson", "Johnson, John Doe");
$cardbook->setPublisher("John and Jane Doe Publications", "http://JohnJaneDoePublications.com/"); // I hope this is a non existant address :)
$cardbook->setDate(time()); // Strictly not needed as the book date defaults to time().
$cardbook->setRights("Copyright and licence information specific for the book."); // As this is generated, this _could_ contain the name or licence information of the user who purchased the book, if needed. If this is used that way, the identifier must also be made unique for the book.
$cardbook->setSourceURL("http://JohnJaneDoePublications.com/books/TestBook.html");
logLine("Set up parameters");

$cssData = "body {\n  margin-left: .5em;\n  margin-right: .5em;\n  text-align: justify;\n}\n\np {\n  font-family: serif;\n  font-size: 10pt;\n  text-align: justify;\n  text-indent: 1em;\n  margin-top: 0px;\n  margin-bottom: 1ex;\n}\n\nh1, h2 {\n  font-family: sans-serif;\n  font-style: italic;\n  text-align: center;\n  background-color: #6b879c;\n  color: white;\n  width: 100%;\n}\n\nh1 {\n    margin-bottom: 2px;\n}\n\nh2 {\n    margin-top: -2px;\n    margin-bottom: 2px;\n}\n";

$cardbook->addCSSFile("styles.css", "css1", $cssData);
logLine("Add css");

// This test requires you have an image, change "demo/cover-image.jpg" to match your location.
$cardbook->setCoverImage("Cover.jpg", file_get_contents("demo/cover-image.jpg"), "image/jpeg");
...
$cardbook->addChapter("Notices", "Cover.html", $cover);
...
$cardbook->addChapter("Chapter 1: Lorem ipsum", "Chapter001.html", $chapter1);
logLine("Add Chapter 2");
$cardbook->addChapter("Chapter 2: Vivamus bibendum massa", "Chapter002.html", $chapter2);
logLine("Add Chapter 3");
$cardbook->addChapter("Chapter 3: Vivamus bibendum massa again", "Chapter003.html", $chapter3);

// Autosplit a chapter:
logLine("Add Chapter 4");
$cardbook->setSplitSize(15000); // For this test, we split at approx 15k. Default is 250000 had we left it alone.
$cardbook->addChapter("Chapter 4: Vivamus bibendum massa split", "Chapter004.html", $chapter4, true);
...
while (list($k, $v) = each($html2)) {
	...
	$cardbook->addChapter($cName, "Chapter005_" . $idx . ".html", $v, true);
}
logLine("Add Chapter 5");
...
$cardbook->addChapter("Chapter 7: Local Image test", "Chapter007.html", $chapter2, false, EPub::EXTERNAL_REF_ADD, $fileDir);
logLine("add chapter 7");

$log .= "\n</pre>" . $bookEnd;
$cardbook->addChapter("Log", "Log.html", $log);

$cardbook->finalize(); // Finalize the book, and build the archive.
...
$cardbook->saveBook('epub-filename', '.');

// Send the book to the client. ".epub" will be appended if missing.
$zipData = $cardbook->sendBook("Example1Book");
